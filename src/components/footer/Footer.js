      ...
      <div className="main-footer">
        ...
        <section className="main-footer-bottom">
          <div className="main-footer-bottom-logo">
            <a href="https://github.com/cedrickmonesit/kixs-server" alt="Kixs API logo link" rel="noopener noreferrer" target="_blank">
              <img className="main-footer-kixs-api-logo" src={kixsApiLogo} alt="Kixs API Logo" />
            </a>
          </div>
